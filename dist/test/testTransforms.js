                ...
                resolvers: {
                    ...
                    Mutation: {
                        setUser: function (parent, _a) {
                            var input = _a.input;
                            if (data[input.id]) {
                                return __assign(__assign({}, data[input.id]), input);
                            }
                        },
                        setAddress: function (parent, _a) {
                            var input = _a.input;
                            if (data[input.id]) {
                                return __assign(__assign({}, data[input.id].address), input);
                            }
                        },
                    },
                },
                            ...
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 2:
                                            userResult = _b.sent();
                                            return [2 /*return*/, __assign(__assign({}, userResult), { address: addressResult })];
                                    }
                                });
                            });
                        },
                        ...
                        addressByUser: function (parent, _a, context, info) {
                            ...
                            return delegateToSchema_1.default({
                                ...
                                transforms: [
                                    ...
                                    new transforms_1.WrapQuery(['userById', 'zip'], function (subtree) { return subtree; }, function (result) { return result; })
                                ],
                            });
                        },
                    },
