...
describe('@directives', function () {
    ...
    it('can handle declared arguments', function () {
        ...
        var visitors = schemaVisitor_1.SchemaDirectiveVisitor.visitSchemaDirectives(schema, {
            oyez: /** @class */ (function (_super) {
                ...
                class_10.getDirectiveDeclaration = function (name, theSchema) {
                ...
                class_10.prototype.visitFieldDefinition = function (field) {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                intl: /** @class */ (function (_super) {
                    ...
                    class_13.prototype.visitFieldDefinition = function (field, details) {
                        var _a = field.resolve, resolve = _a === void 0 ? graphql_1.defaultFieldResolver : _a;
                        field.resolve = function () {
                            var args = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
                    ...
                    schema = makeExecutableSchema_1.makeExecutableSchema({
                        ...
                        schemaDirectives: {
                            length: /** @class */ (function (_super) {
                                ...
                                class_14.prototype.visitInputFieldDefinition = function (field) {
                                    this.wrapType(field);
                                };
                                class_14.prototype.visitFieldDefinition = function (field) {
                                    this.wrapType(field);
                                };
                                class_14.prototype.wrapType = function (field) {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                uniqueID: /** @class */ (function (_super) {
                    ...
                    class_15.prototype.visitObject = function (type) {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                objectTypeDirective: /** @class */ (function (_super) {
                    ...
                    class_16.prototype.visitObject = function (object) {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                remove: /** @class */ (function (_super) {
                    ...
                    class_17.prototype.visitEnumValue = function (value) {
                        if (this.args.if) {
                            return null;
                        }
                    };
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                rename: /** @class */ (function (_super) {
                    ...
                    class_18.prototype.visitObject = function (object) {
        ...
        var schema = makeExecutableSchema_1.makeExecutableSchema({
            ...
            schemaDirectives: {
                upper: /** @class */ (function (_super) {
                    ...
                    class_20.prototype.visitFieldDefinition = function (field) {
                        var _a = field.resolve, resolve = _a === void 0 ? graphql_1.defaultFieldResolver : _a;
